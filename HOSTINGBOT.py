...
TOKEN = '8397979620:AAFEU4RHPJhOeq2MFGA7hkOWqLQ9GOQ5uNM'
OWNER_ID = 8609980572
ADMIN_ID = 8609980572
YOUR_USERNAME = '@DANGER_COMEBACK'
UPDATE_CHANNEL = ''
...
def init_db():
    ...
    try:
        ...
        c = conn.cursor()
        # Keep subscriptions table for backward compatibility but never use it
...
# No file limits – everyone gets unlimited uploads
